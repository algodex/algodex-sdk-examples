...
test('Can get planned order changes', () => {
    ...
    const { createEscrowPrices, cancelSet } = getPlannedOrderChanges({ config, currentEscrows, latestPrice });
    ...
    expect(getEscrowsToCancelAndMakeMock.calls).toEqual([[{ 'escrows': ['escrow_addr_1', 'escrow_addr_2'], 'latestPrice': 44.25,
