...
test('Only one order is still open', async () => {
  const indexer = null;
  const openAccountSet = new Set(['7P5TBOLTNFHNQE5NP7EQP4CMYJEQM555OVC75SZ7EWV4SGWZXDG7AJJQ7A']);
  const currentOrders = await getCurrentOrders(escrowDB, indexer, openAccountSet);
