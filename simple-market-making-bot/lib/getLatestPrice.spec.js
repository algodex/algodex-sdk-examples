...
jest.mock('axios', req => jest.fn(req => {
  if (req.url === 'https://testnet.algodex.com/algodex-backend/assets.php') {
    return {data:
        {'ok': true, 'rows': 237, 'data':
        [{'id': 442424, 'unix_time': 1657428189,
          'price': 0.068907007455, 'priceBefore':
          0.068907007455, 'price24Change': 0, 'isTraded': true},
    ...
    return {data: {'0': {'price': 2}, '542132831':
    {'price': 2.1e-05}, '793124631': {'price': 0.330026},
    '378382099': {'price': 0.190918}}};
  } else if (req.url === 'https://testnet.analytics.tinyman.org/api/v1/current-asset-prices/') {
    return {data: {'0': {'price': 2}, '111':
    {'price': 555}, '233': {'price': 0.777}, '444': {'price': 0.999}}};
  }
}).mockName('axios'));
