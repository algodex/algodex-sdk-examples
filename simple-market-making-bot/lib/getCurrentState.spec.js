...
test('Calls all state initialization functions', async() => {
  ...
  expect(getCurrentOrdersMock.calls).toEqual([["escrow DB object","algorand indexer obj","openAccountSet"]]);
  expect(getOpenAccountSetFromAlgodexMock.calls).toEqual([["testnet","my wallet address",5555]]);
